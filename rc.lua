...
-- {{{ Tags
 tags = {
   names  = { "www", "terminal", "mail", "java", "C", "irc", "code", "media", "spotify"},
   layout = { layouts[10], layouts[2], layouts[10], layouts[10], layouts[2],
              layouts[2], layouts[6], layouts[5], layouts[6]
 }}
...
--memicon.image = image("/home/jfalco/.config/awesome/icons/mem.png")
-- Initilize widget
...
--cpuicon.image = image("/home/jfalco/.config/awesome/icons/cpu.png")
-- Initilize widget
...
netwidget = widget({ type = "textbox" }) --wibox.widget.textbox()
-- Register widget
vicious.register(netwidget, vicious.widgets.net, "${wlan0 up_kb}kb/s / ${wlan0 down_kb}kb/s", 1)

-- Initilize battery widget
batwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(batwidget, vicious.widgets.bat, "BAT: $2%", 31, "BAT0")
...
awful.rules.rules = {
    ...
    { rule = { class = "pinentry" },
      properties = { floating = true } },
    -- Set Chrome to always map on tag screen 1 tag 1
    { rule = { class = "Google-chrome" },  
      properties = {tag = tags[1][1]}},
    -- Set Xchat to always map on tag number 6 of screen 1
    { rule = { class = "Xchat" },
